...
const get_autocomplete_providers = () => {
    // console.log("Getting autocomplete providers");
    const res = []
...
module.exports = {
    activate: function() {
        ...
        // this.FilesView=new baconfiles.FilesView()
        // Events subscribed to in atom's system can be easily cleaned up with a CompositeDisposable
        // this.subscriptions = new atm.CompositeDisposable()

        // Register command that toggles this view
        // this.subscriptions.add(atom.commands.add('atom-workspace', {
          // 'bacontools:List Unimplemented': () => baconfiles.ListUnimplemented(),
          // 'bacontools:List Missing': () => baconfiles.ListMissing()
        // }));
    ...
    config:{
        ...
        addToClipboard:{
          title: "Put selected file to clipboard",
          type: "boolean",
          default: false
        },
        writeInEditor:{
          title: "Write selected file in editor",
          type: "boolean",
          default: true
        },
        commandFiles:{
